...
export const productData: BaseProduct[] = [
  {
    ...
    quantitySold: 1000,
    quantity: 500,
    productTypeId: "1", // ProductTypeId liên kết với loại sản phẩm iPhone
    brandId: "1", // BrandId liên kết với Apple
    discountPercent: 10, // Tùy chọn, có thể để null nếu không có giảm giá
    baseDescription: "Latest flagship from Apple.",
  },
  {
    id: "2",
    ...
    brandId: "1",
    discountPercent: 10,
    baseDescription: "Flagship mới nhất từ Apple.",
  },
  {
    id: "3",
    ...
    brandId: "1",
    discountPercent: 15,
    baseDescription: "Siêu phẩm Apple cao cấp nhất.",
  },
];
